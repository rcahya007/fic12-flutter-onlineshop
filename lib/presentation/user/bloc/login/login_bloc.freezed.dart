...
mixin _$LoginState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(AuthResponseModel auth) loaded,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(AuthResponseModel auth)? loaded,
...
abstract class _$$LoadedImplCopyWith<$Res> {
  ...
  @useResult
  $Res call({AuthResponseModel auth});
}
...
class _$LoadedImpl implements _Loaded {
  ...
  @override
  String toString() {
    return 'LoginState.loaded(auth: $auth)';
  }
...
abstract class _Loaded implements LoginState {
  const factory _Loaded(final AuthResponseModel auth) = _$LoadedImpl;

  AuthResponseModel get auth;
  @JsonKey(ignore: true)
  _$$LoadedImplCopyWith<_$LoadedImpl> get copyWith =>
      throw _privateConstructorUsedError;
}
